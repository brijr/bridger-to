...
description: "This guide covers implementing Lenis in Next.js 15 with React 19 support and the latest best practices."
date: "2025-08-15"
published: true
---
...
- Scroll snapping support via `lenis/snap`
- Performance optimization
- Easy integration with animation libraries
- Small bundle size (check current package stats for exact numbers)
...
When driving Lenis from GSAP's ticker, configure Lenis with `autoRaf: false` so there is only one RAF loop.
