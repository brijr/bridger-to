...
## Automate Translations with AI

I built a plugin called [payload-translate](https://github.com/brijr/payload-translate) that enables AI-powered translations between locales in Payload CMS. It integrates directly into the admin panel, making it easy to translate content without leaving the CMS.

<Tweet id="1998060277653459089" />
